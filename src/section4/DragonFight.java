...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		// 8. Ask the player in a pop-up if they want to attack the dragon with a yell or a kick
			String y = JOptionPane.showInputDialog("Do you want to 'yell' or 'kick'?");
		...
		// 14. Else if the dragon's health is less than or equal to 0
			...
			//-- Tell the user that the dragon is dead and they took a ton of gold!
				JOptionPane.showMessageDialog(null, "The dragon is dead. You won a ton of gold!");
			}
	   //  15.  Else
			else {
			//-- Pop up a message that tells the their current health and the dragon's currently health (Bonus: Also display the amount of health that was lost for each player this round)
				JOptionPane.showMessageDialog(null, "Your health is : " + playerHealth + "\n" + "The dragon's health is : " + dragonHealth + "\n" + "You lost " + playerDamage + " health this round.\n" + "The dragon lost " + dragonDamage + " health this round.\n");
			}
		}
	}
}
